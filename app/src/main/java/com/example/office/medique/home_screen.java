...
/*View view=navigationView.inflateHeaderView(R.layout.nav_header_main);*/
        ...
        String hospname=sharedPrefManager.getInstance(getApplicationContext()).getHospital();
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new Rejected_fragment(), "Rejected");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id == R.id.Addbranch)
        {
            startActivity(new Intent(home_screen.this,SettingsActivity.class));
        }
